...
This sample Android application obtains an access token from [Cloudentity](https://cloudentity.com/developers/app-dev-tutorials/android/android-pkce-tutorial/) using Authorization Code grant and PKCE.
